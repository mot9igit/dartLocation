...
class dartLocationResourceGetListProcessor extends modObjectGetListProcessor {
    ...
    public function prepareRow(xPDOObject $object) {
        ...
        $array['city'] = $this->modx->dartLocation->getCityNameById($array['city']);
        $array['value'] = mb_substr(strip_tags($array['value']), 0, 60);
        $array['actions'] = [];
        // Edit
        $array['actions'][] = [
            'cls' => 'dartlocation-update',
            'icon' => 'icon icon-edit',
...
return "dartLocationResourceGetListProcessor";